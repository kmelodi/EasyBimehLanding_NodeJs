...
/**
 * Creates an instance of BaseModelFireInsurance
 */
class BaseModelFireInsurance extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'message', realName: 'message', type: 'FireInsurance' },
...
module.exports = BaseModelFireInsurance;
