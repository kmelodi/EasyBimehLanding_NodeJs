...
/**
 * Creates an instance of InsuranceDataFireInsurance
 */
class InsuranceDataFireInsurance extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.insurancePolicyTypeVelue = this.constructor.getValue(obj.insurancePolicyTypeVelue);
        this.fireInsurancePolicyExtendView =
          this.constructor.getValue(obj.fireInsurancePolicyExtendView);
        this.fireInsurancePolicyFilter = this.constructor.getValue(obj.fireInsurancePolicyFilter);
...
module.exports = InsuranceDataFireInsurance;
