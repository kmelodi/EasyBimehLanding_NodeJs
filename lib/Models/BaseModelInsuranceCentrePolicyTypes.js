...
/**
 * Creates an instance of BaseModelInsuranceCentrePolicyTypes
 */
class BaseModelInsuranceCentrePolicyTypes extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'status', realName: 'status' },
            {
                ...
                realName: 'message',
                array: true,
                type: 'InsuranceCentrePolicyTypes',
            },
            {
                name: 'extraData',
                realName: 'extraData',
                type: 'ExtraDataBaseModelInsuranceCentrePolicyTypes',
            },
...
module.exports = BaseModelInsuranceCentrePolicyTypes;
