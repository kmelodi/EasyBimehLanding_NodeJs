...
/**
 * Creates an instance of BaseModelPortalLandingPage
 */
class BaseModelPortalLandingPage extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'message', realName: 'message', type: 'PortalLandingPage' },
            {
                name: 'extraData',
                realName: 'extraData',
                type: 'ExtraDataBaseModelPortalLandingPage',
            },
...
module.exports = BaseModelPortalLandingPage;
