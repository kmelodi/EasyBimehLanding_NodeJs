...
/**
 * Creates an instance of CarBrandTips
 */
class CarBrandTips extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'message', realName: 'message', array: true, type: 'CarBrandTipsModel' },
