...
/**
 * Creates an instance of InsuranceDataLiabilityDoctorInsurance
 */
class InsuranceDataLiabilityDoctorInsurance extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.liabilityDoctorInsurancePolicyExtendView =
          this.constructor.getValue(obj.liabilityDoctorInsurancePolicyExtendView);
        this.liabilityDoctorInsurancePolicyFilter =
          this.constructor.getValue(obj.liabilityDoctorInsurancePolicyFilter);
...
module.exports = InsuranceDataLiabilityDoctorInsurance;
