...
class EarthquakeInsuranceController {
     ...
     * @returns {Promise}
     */
    static getEarthquake(subDomain, insurancePolicyId, insurancePolicyType, xApiKey, callback) {
        ...
        const _pathUrl = '/FireInsurance/Initialize';
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    parsed = _baseController.getObjectMapper().mapObject(parsed, 'BaseModelEarthquake');
...
module.exports = EarthquakeInsuranceController;
